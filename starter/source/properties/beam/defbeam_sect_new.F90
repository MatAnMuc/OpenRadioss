...
!           section properties           
            ...
            iyy = two*l(1)*l(2)**3/twelve + two*l(1)*l(2)*(half*(l(3)-l(2)))**2 + l(4)*(l(3)-two*l(2))**3/twelve
...
!           section properties                
            ...
            iyy = two*(l(1)*l(2)**3/twelve + l(1)*l(2)*(half*(l(3)-l(2)))**2) + l(4)*(l(3)-two*l(2))**3/twelve
            izz = two*(l(2)*l(1)**3/twelve + l(1)*l(2)*(ycog**2)) + l(4)*(l(3)-two*l(2))*(-half*(l(1)-l(4))-ycog)**2   &
...
!           section properties           
            ...
            iyy = l(4)*da**3/twelve + l(4)*da*(half*l(2)-zcog)**2 + db*l(2)**3/twelve + l(2)*db*(-half*da-zcog)**2 &
                + l(4)*l(2)**3/twelve + l(2)*l(4)*(-half*da-zcog)**2
            izz = da*l(4)**3/twelve + l(4)*da*(-half*db-ycog)**2 + l(2)*db**3/twelve + l(2)*db*(half*l(4)-ycog)**2 &
                + l(2)*l(4)**3/twelve + l(2)*l(4)*(-half*db-ycog)**2
            ixx = iyy + izz
!           torsion factor
...
!           section properties            
            ...
            iyy = l(1)*l(2)**3/twelve + l(1)*l(2)*(half*(l(3)-l(2))-zcog)**2 + l(4)*(l(3)-l(2))**3/twelve &
                + l(4)*(l(3)-l(2))*(-half*l(2)-zcog)**2
...
!           section properties            
            ...
            ixx = iyy + izz
!           torsion factor            
            geo(90) = two*l(2)*l(4)*((l(1)-l(4))**2)*((l(3)-l(2))**2)/(l(1)*l(4)+l(2)*l(3)-l(2)**2-l(4)**2)/ixx            
            fac = one/(intr+3)
            fac2 = one/(intr+1)
            area1_i = l(1)*l(2)*fac
...
!           torsion factor
            db = fourth*(l(1)-l(4))
            dc = half*(l(3)-l(2))
            iyy = two*(half*(l(1)+l(4))*l(2)**3/twelve + half*(l(1)+l(4))*l(2)*dc**2) + l(4)*(l(3)-two*l(2))**3/twelve
            izz = two*(l(2)*(half*(l(1)+l(4)))**3/twelve + half*(l(1)+l(4))*l(2)*db**2) + (l(3)-two*l(2))*l(4)**3/twelve
            ixx = iyy + izz
...
!           section properties
            ...
            zcog = (l(3)*l(6)*half*(l(1)-l(6)) - l(2)*l(5)*half*(l(1)-l(5)) + l(4)*(l(1)-l(5)-l(6))*half*(l(5)-l(6)))/area
...
!           section properties
            ...
            izz = two*(l(3)*l(1)**3/twelve + l(1)*l(3)*(half*(l(4)-l(1)))**2) + (l(4)-two*l(1))*l(2)**3/twelve
            ixx = iyy + izz
!           torsion factor
